...
const ProductTable = ({ salesdata }) => {
    ...
    const handleSubmit = (e) => {
        ...
        axios.post(`/api/products/updateProduct`, { id: modalViewData.id, title: title, price: price, vendor: vendor, brand: brand, stock: stock, weight: weight })
                                ...
                                {actions.map((item, i) => (
                                    <Menu.Item key={i}>
                                        <div
                                            ...
                                            className={`
                                                ${item.name === "delete" ? "bg-danger-500 text-danger-500 bg-opacity-30 hover:bg-opacity-100 hover:text-white" : "hover:bg-slate-900 hover:text-white dark:hover:bg-slate-600 dark:hover:bg-opacity-50"}
    ...
    const deleteProduct = () => {
        closeModalDel();
        axios.post(`/api/products/deleteProduct`, { id: modalDeleteData.id })
                        ...
                        <div className="px-6 py-6 lg:px-8">
                            ...
                            <div className="flex space-x-4">
                                    <div className="w-1/2 space-y-4">
                                        <Textinput label="Title" defaultValue={modalViewData?.title} onChange={
                                            (e) => setModalEditData({ ...modalEditData, title: e.target.value })
                                        }
                                        id="title"
                                         />
                                        <Textinput label="Price" defaultValue={modalViewData?.price} onChange={
                                            (e) => setModalEditData({ ...modalEditData, price: e.target.value })
                                        }
                                        id="price"
                                         />
                                        <Textinput label="Vendor" defaultValue={modalViewData?.vendor}  onChange={
                                            (e) => setModalEditData({ ...modalEditData, vendor: e.target.value })
                                        }
                                        id="vendor"
                                         />
                                        <Textinput label="Brand" defaultValue={modalViewData?.brand} onChange={
                                            (e) => setModalEditData({ ...modalEditData, brand: e.target.value })
                                        }
                                        id="brand"
                                         />
                                    </div>
                                    <div className="w-1/2 space-y-4">
                                        ...
                                        readonly={true}
                                         ...
                                         />
                                        <Textarea label="Categories" value={modalViewData?.categoriesNames.join(', ')} onChange={
                                            (e) => setModalEditData({ ...modalEditData, categories: e.target.value })
                                        } readonly={true} />
                                        <Textinput label="Stock" defaultValue={modalViewData?.stock} onChange={
                                            (e) => setModalEditData({ ...modalEditData, stock: e.target.value })
                                        }
                                        id="stock"
                                         />
                                        <Textinput label="Weight" defaultValue={modalViewData?.weight} onChange={
                                            (e) => setModalEditData({ ...modalEditData, weight: e.target.value })
                                        } 
                                        id="weight"
                                        />
