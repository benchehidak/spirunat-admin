    ...
    <>
      {session ? (
        <Menu as='div' className='relative'>
          ...
          >
            <Menu.Items className={isMobile?'bg-react dark:text-react absolute right-0 mt-1 flex origin-top-right w-72 flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white':'bg-react dark:text-react absolute right-0 mt-1 flex origin-top-right flex-col rounded-xl py-6 text-white shadow-lg focus:outline-none dark:bg-white w-96'}>
